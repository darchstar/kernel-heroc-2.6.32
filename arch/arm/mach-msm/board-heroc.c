...
static struct msm_hsusb_platform_data msm_hsusb_pdata = {
       ...
       .phy_reset              = heroc_phy_reset,
       .usb_id_pin_gpio =  HEROC_GPIO_USB_ID_PIN,
};
...
static void heroc_add_usb_devices(void)
{
...
static void __init config_gpios(void)
{
	...
	config = PCOM_GPIO_CFG(HEROC_MDDI_VSYNC, 1, GPIO_INPUT, GPIO_PULL_DOWN, GPIO_2MA);
}
